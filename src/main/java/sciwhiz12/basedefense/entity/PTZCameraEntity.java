...
import sciwhiz12.basedefense.init.ModEntities;

public class PTZCameraEntity extends Entity {
    public static final Rotations DEFAULT_ROTATION = new Rotations(0F, 0F, 0F);
    private static final DataParameter<Rotations> ROTATION_DATA = EntityDataManager.createKey(PTZCameraEntity.class,
    ...
    public PTZCameraEntity(World world, double posX, double posY, double posZ) {
        this(ModEntities.PTZ_CAMERA, world);
